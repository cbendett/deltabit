...
def ingroup_blast():
    #Define the command
    command = f'db2search -d {args.ingroup_mtdb} -q proximal_genes.fa -a blastp -o ingroup_blast -c {args.threads}'
...
def outgroup_blast():
    #Define the command
    command1 = f'db2search -d {args.outgroup_mtdb} -q proximal_genes.fa -a blastp -o outgroup_blast -c {args.threads}'
